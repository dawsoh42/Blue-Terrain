...
function createMap(){
    ...
    var apitoken = 'Your Token' //Enter your API Token - go to 'https://www.mapbox.com/install/' to yours */
    ...
    var customeBasemap = L.tileLayer(mbStyleUrl, {id: 'dawsoh5/clba6z67d003y15rsew8ekwxd', token: apitoken,  attribution: mbAttr});
